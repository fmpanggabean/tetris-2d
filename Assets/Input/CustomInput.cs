...
public partial class @CustomInput : IInputActionCollection2, IDisposable
{
    ...
    public struct GameplayActions
    {
        ...
        public void SetCallbacks(IGameplayActions instance)
        {
            ...
            {
                @Immediate.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnImmediate;
                @Immediate.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnImmediate;
                @Immediate.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnImmediate;
                @Fast.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnFast;
                @Fast.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnFast;
                @Fast.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnFast;
                @RotatePiece.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnRotatePiece;
                @RotatePiece.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnRotatePiece;
                @RotatePiece.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnRotatePiece;
                @MovePiece.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnMovePiece;
                @MovePiece.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnMovePiece;
                @MovePiece.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnMovePiece;
            }
